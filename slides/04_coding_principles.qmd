...
::: {.column width='50%'}
!["The Treachery of Images" by René Magritte](img/MagrittePipe.jpg){.nostretch fig-align="center" width="40%"}
:::

::: {.column width='50%'}
![Pipe operator from magrittr package](img/magrittr_logo.png){.nostretch fig-align="center" width="25%"}
:::
