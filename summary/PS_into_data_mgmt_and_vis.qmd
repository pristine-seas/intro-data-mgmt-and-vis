...
- Create a new project in RStudio using the version control option and clone the sample repository we created ("research-retreat") from the Pristine Seas Github. 
:::
...
We can do most things in RStudio, but it's also possible to do everything through terminal/command line... 
